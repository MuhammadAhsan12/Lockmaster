...
import { getAccountRecoveryCode } from "../store/actions/userActions";
...
const ForgetPassword = () => {
  ...
  return (
    <>
   {!verification && <ForgetPasswordContainer>
    ...
    {verification && <Verification open={(e)=>setVerification(e)} email={email}/>}
    </>
  );
};
